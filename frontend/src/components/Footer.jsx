...
function Footer() {
    return (
        <footer className="gradient-bg border-t border-gray-700">
            <div className="max-w-6xl mx-auto py-12 px-6">
                <div className="grid md:grid-cols-4 gap-8">                    
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a href="/codebase" className="text-gray-300 hover:text-blue-400 transition-colors duration-300">
                                    Codebase
                                </a>
                            </li>
                            <li>
                                <a href="/history" className="text-gray-300 hover:text-blue-400 transition-colors duration-300">
                                    History
                                </a>
                            </li>
                        </ul>
                ...
                <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm">
                        &copy; 2025 CodeSearchEngine. Built with ❤️ for developers.
                    </p>                    
                </div>
            </div>
        </footer>
